...
docker run -i -e "USERDB=iris_base" -e "USERID=postgres" -e "USERPWD=p0stgr3S" -e "DBIP=10.10.0.19"  -e "LONG_SHORT=L" -v /dev/log:/dev/log mauromussin/myscriptr:recupero_RT-pgsql
